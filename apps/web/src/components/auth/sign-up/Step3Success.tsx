...
export function Step3Success() {
  ...
  return (
    <div className="w-[460px] bg-surface border border-border rounded-[20px] p-[40px] text-center">
      <StepIndicator current={step} />

      <div
        className="w-[72px] h-[72px] rounded-full bg-green/10 border border-green/30
                      flex items-center justify-center text-[32px] mx-auto mb-5"
      >
        🎉
      </div>

      <h1 className="text-[22px] font-bold tracking-[-0.4px] mb-2">
        You're all set, {data.firstName}!
      </h1>
      <p className="text-t3 text-[13px] mb-6 leading-relaxed">
      ...
      <button
        onClick={handleGo}
        className="w-full bg-[linear-gradient(135deg,var(--primary),#4f46e5)] text-white
      ...
      <p className="text-t3 text-[12px] mt-4">
